...
//
//    ViewController * nav = [[ViewController alloc] initWithRootViewController:[[UIViewController alloc] init]];
...
//    [nav pushViewController:view3 animated:YES];
//    
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"QQ______"];
